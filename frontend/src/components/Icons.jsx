...
// Kept inline to avoid an extra dependency and to let Tailwind size/color them
// via className + currentColor.
...
export const BoltIcon = (props) => (
  <svg {...base} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5 13.5 3l-3 7.5h6.75L8.25 21l2.25-7.5H3.75Z" />
  </svg>
);
